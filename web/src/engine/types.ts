export type EngineMode =
  'human-engine' | 'human-stockfish' | 'engine-engine' | 'mojo-stockfish' | 'human-human'
...
export type WorkerMessage = AnalysisMessage | CompleteMessage | ErrorMessage | ReadyMessage
