...
export const analyze_step: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const engine_analyze_depth: (a: number, b: number, c: number, d: number, e: number) => void;
...
export const fallback_move: (a: number, b: number, c: number) => void;
