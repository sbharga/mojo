/* @ts-self-types="./mojo_engine.d.ts" */
...
export class Engine {
     ...
     * @returns {any}
     */
    analyze_depth(depth, multi_pv, time_limit_ms) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.engine_analyze_depth(retptr, this.__wbg_ptr, depth, multi_pv, time_limit_ms);
    ...
    fallback_move() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.engine_fallback_move(retptr, this.__wbg_ptr);
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            let v1;
            if (r0 !== 0) {
     ...
     * @param {string} fen
     * @param {any} prior_fens
     */
    set_position(fen, prior_fens) {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            const ptr0 = passStringToWasm0(fen, wasm.__wbindgen_export, wasm.__wbindgen_export2);
            const len0 = WASM_VECTOR_LEN;
            wasm.engine_set_position(retptr, this.__wbg_ptr, ptr0, len0, addHeapObject(prior_fens));
            var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
            var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
            if (r1) {
                throw takeObject(r0);
 ...
 * @returns {any}
 */
export function analyze_step(fen, depth, multi_pv, time_limit_ms) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(fen, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.analyze_step(retptr, ptr0, len0, depth, multi_pv, time_limit_ms);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
        if (r2) {
 ...
 * @returns {string | undefined}
 */
export function fallback_move(fen) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(fen, wasm.__wbindgen_export, wasm.__wbindgen_export2);
        const len0 = WASM_VECTOR_LEN;
        wasm.fallback_move(retptr, ptr0, len0);
        var r0 = getDataViewMemory0().getInt32(retptr + 4 * 0, true);
        var r1 = getDataViewMemory0().getInt32(retptr + 4 * 1, true);
        var r2 = getDataViewMemory0().getInt32(retptr + 4 * 2, true);
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_now_321acb4fb64fdfab: function() {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('mojo_engine_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
